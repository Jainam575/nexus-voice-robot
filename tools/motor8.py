...
# These BCM pins map to physical pins 29, 31, 32, 33, 36, 35
# NOTE: MOTOR_B_IN4 uses GPIO 19 / physical pin 35 — pin 37 (GPIO 26) is DEAD on this Pi
...
MOTOR_B_IN4 = 19  # Input 4 for Motor B            - Physical pin 35 (between pin 33 and the dead pin 37)
